...
export default function DocumentsPage() {
  ...
  return (
    <div className="page-wrapper">
      ...
      {/* Nội dung trang Documents (giữ nguyên) */}
      <main className="documents-main">
        ...
        <nav className="pagination">
          ...
          >
            ...
            >
              <path
                d="M12.6667 8.00001H3.33333M3.33333 8.00001L7.99999 12.6667M3.33333 8.00001L7.99999 3.33334"
                stroke="#1E1E1E"
                strokeWidth="1.6"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="pagination-pages">
            <button className="pagination-page pagination-page--current">
              1
            </button>
