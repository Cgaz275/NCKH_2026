...
export default function ChatbotPage() {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false); // ← sidebar chat (đã có)
  ...
  return (
    <div className="page-wrapper">
      ...
      {/* Chatbot Layout */}
      <div
        className={`chatbot-layout ${sidebarOpen ? 'chat-sidebar--open' : ''}`}
      >
        {/* Sidebar */}
                ...
                <div className="chat-list-section">
                  ...
                  <ul className="chat-list">
                    {chats.map((chat) => (
                      <li
                        key={chat.id}
                        className={`chat-list-item${chat.active ? ' chat-list-item--active' : ''}`}
                      >
                        {chat.name}
                      </li>
                    ))}
            ...
            <div className="chat-bot-message">
              <div className="chat-bot-header">
                ...
                <p className="chat-bot-text">
                  ...
                  project. It is built using React, and uses the local time for
                  London, England as standard. Let me know if you would like to
...
import`}
                    ...
                    <span className="code-keyword">from</span>
                    {` `}
                    <span className="code-string">"figma:react"</span>
                    {`;
...
`}
                    ...
                    <span className="code-fn">AnalogClock</span>
                    {`({
  updateInterval `}
  ...
  secondHandColor `}
                    <span className="code-keyword">=</span>
                    {` `}
                    <span className="code-string">"red"</span>
                    {`,
  minuteHandColor `}
                    <span className="code-keyword">=</span>
                    {` `}
                    <span className="code-string">"black"</span>
                    {`,
  hourHandColor `}
                    <span className="code-keyword">=</span>
                    {` `}
  ...
  `}
                    ...
                    <span className="code-fn">useState</span>
                    {`({ `}
                    <span className="code-prop">hours</span>
                    {`: `}
                    <span className="code-number">0</span>
                    {`, `}
                    <span className="code-prop">minutes</span>
                    {`: `}
                    <span className="code-number">0</span>
                    {`, `}
                    <span className="code-prop">seconds</span>
                    {`: `}
                    <span className="code-number">0</span>
                    {` });
...
`}
      ...
      `}
                    ...
                    <span className="code-prop">Date</span>
                    {`().`}
                    <span className="code-prop">toLocaleTimeString</span>
                    {`(`}
                    <span className="code-string">"en-GB"</span>
                    {`, {
        `}
                    <span className="code-prop">timeZone</span>
                    <span className="code-keyword">:</span>
                    {` `}
                    <span className="code-string">"Europe/London"</span>
                    {`,
        `}
                    <span className="code-prop">hour12</span>
                    <span className="code-keyword">:</span>
                    {` `}
      ...
      `}
                    ...
                    <span className="code-keyword">= </span>
                    {`londonTimeString.`}
                    <span className="code-prop">split</span>
                    {`(`}
      ...
      `}
        ...
        `}
                    <span className="code-prop">hours</span>
                    {`: `}
                    <span className="code-fn">parseInt</span>
                    {`(hoursStr, `}
    ...
    `}
                    ...
                    <span className="code-keyword">=</span>
                    {` `}
                    <span className="code-fn">setInterval</span>
    ...
    `}
                    ...
                    <span className="code-keyword">=&gt;</span>
                    {` `}
                    <span className="code-fn">clearInterval</span>
                    {`(timerId);
  }, [updateInterval]);`}
                  </code>
                </pre>
          ...
          <div className="chat-input-box">
            <p className="chat-input-placeholder">
            ...
            <div className="chat-input-actions">
              ...
              >
                ...
                >
                  <path
                    d="M9.99996 15.8333V4.16666M9.99996 4.16666L4.16663 10M9.99996 4.16666L15.8333 10"
                    stroke="#B3B3B3"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
